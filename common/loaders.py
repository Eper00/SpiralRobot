"""RL training configuration loader (robust version)."""
...
class RLEnvironmentConfig(BaseModel):
    ...
    tip_site_name: str = "tip_center"
    target_bounds_min: List[float] = [-0.2, -0.2, 0.125]
    target_bounds_max: List[float] = [0.2, 0.2, 0.1255]

    num_frames: int = 6
    include_actuator_lengths_in_obs: bool = True
